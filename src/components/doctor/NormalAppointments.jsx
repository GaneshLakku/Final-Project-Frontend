...
const NormalAppointments = () => {
  console.log('NormalAppointments rendered');
  ...
  const fetchAllAppointmentsForDoctor = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/appointments/doctor/${doctorData._id}/normal`, {
        headers: {
    ...
    <div className="appointments-section">
      <div className="section-header">
        <h2 className="section-title">
          <i className="bx bx-calendar"></i> Normal Appointments
        </h2>
        <button
